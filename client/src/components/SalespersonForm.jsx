          ...
          <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center p-4 z-[99999]">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 text-left text-xs sm:text-sm bg-[var(--color-surface)] p-4 rounded-2xl border border-[var(--color-border)] text-[var(--color-heading)]">
                <p>
                  ⏱️ Start Time: <strong>{daySummaryModal.startTime}</strong>
                </p>
                <p>
                  🏁 End Time: <strong>{daySummaryModal.endTime}</strong>
                </p>
                <p>
                  ⏳ Working Hours:{" "}
                  <strong>{daySummaryModal.workingHours}</strong>
                </p>
                <p>
                  📍 Total Visits:{" "}
                  <strong className="text-blue-600">
                    {daySummaryModal.totalVisits}
                  </strong>
                </p>
                <p>
                  💰 Collections:{" "}
                  <strong className="text-emerald-600">
                    ₹{daySummaryModal.totalCollected?.toLocaleString("en-IN")}
                  </strong>
                </p>
                <p>
                  🛣️ Distance:{" "}
                  <strong className="text-purple-600">
                    {daySummaryModal.totalDistanceKm} KM
                  </strong>
                </p>
              </div>
