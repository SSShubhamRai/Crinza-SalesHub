  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] p-4 md:p-8 transition-colors duration-300">
      <div className="max-w-6xl mx-auto space-y-6 animate-fade-in">
        ...
        {/* 🚪 Logout Confirmation Modal - Fully Centered */}
        {showLogoutModal && (
        ...
        {lightboxUrl && (
          ...
          >
            <div className="relative max-w-4xl max-h-[90vh] overflow-auto bg-[var(--color-card)] p-3 rounded-3xl border border-[var(--color-border)] shadow-2xl transition-all transform scale-100 animate-in zoom-in-95 duration-200 mx-auto my-auto" onClick={(e) => e.stopPropagation()}>
